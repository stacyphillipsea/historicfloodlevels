...
app.layout = dbc.Container([
        ...
        dbc.Row([
            ...
            dbc.Col([
                html.A(
                    [
                        html.Img(
                            src="https://eveshamobserver.co.uk/wp-content/uploads/2024/01/P1140242-650x434.jpg", 
                            style={"width": "100%"}), 
                        html.P(
                            "The Avon bursting it's banks in Evesham", 
                            style={"textAlign": "center", "fontStyle": "italic", "color": "gray", "font-size":"12px", "margin-bottom": "5px"} # Adjust margin-top
                        ),
                        html.P(
                            "Photo from Evesham Observer", 
                            style={"textAlign": "center", "fontStyle": "italic", "color": "gray", "font-size":"10px"}  
                        )
                    ],
                    href="https://eveshamobserver.co.uk/wp-content/uploads/2024/01/P1140242-650x434.jpg",
    ...
    dbc.Row([
        dbc.Col([
            ...
            dcc.Dropdown(
                id="station-dropdown",
                clearable=False,
                value="Evesham",  # Default value for the station dropdown
    ...
    dbc.Row([
        dbc.Col(
            html.Div([
                html.H2("River levels for this station over September 2024",id="peak-info", 
        ...
        dbc.Col(
            html.Div([
                html.H2("Peaks identified for this station over September 2024", style={"textAlign": "center", 'font-size': '14px'}),
    ...
    dbc.Row([
        ...
        dbc.Col(
            html.Div([
                html.H2("September 2024 peaks versus historic levels", style={"textAlign": "center", 'font-size': '14px'}),
    ...
    dbc.Row([
        dbc.Col(
            html.Div([
                html.H2("These stations experienced exceptional (top-10 all-time) historic levels this winter", 
                        style={"textAlign": "center", 'font-size': '14px'}),

                # Conditional rendering based on whether the dataframe is empty or not
                html.Div([
                    dash_table.DataTable(
                        id='top-ten-rank',
                        ...
                        sort_action="native",
                    ) if not top_ten_records.empty else html.P(
                        "No stations that have historical records experienced a top-10 event this September",
                        style={'textAlign': 'center', 'font-size': '12px', 'padding': '10px'}
                    )
                ]),
            ]),
            width=12
